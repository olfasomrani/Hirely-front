...
import { BellOutlined, SearchOutlined, UserOutlined, DownOutlined, SettingOutlined, LogoutOutlined, ProfileOutlined } from '@ant-design/icons';
import useAuth from '../../hooks/useAuth';

const Header = () => {
  const { user, logout } = useAuth(); // Utilise useAuth pour récupérer l'utilisateur et la fonction de déconnexion
      ...
      <div className="flex items-center gap-4">
        ...
        <Dropdown overlay={menu} placement="bottomRight" arrow trigger={['click']}>
          <div className="flex items-center gap-2 cursor-pointer hover:opacity-90">
            ...
            <span className="hidden sm:inline font-medium text-sm">{user?.firstName} {user?.lastName}</span>
